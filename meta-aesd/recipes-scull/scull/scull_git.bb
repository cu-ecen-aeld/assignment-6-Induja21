...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignment-7-Induja21.git;protocol=ssh;branch=main \
           file://0001-Update-Makefile-to-include-only-misc-modules-and-scu.patch \
           file://ldd-scull \
           file://scull_load.sh \
...
PV = "1.0+git${SRCPV}"
SRCREV = "f7c439cba0e2ed885a3cb7a469b409ca7924f047"
